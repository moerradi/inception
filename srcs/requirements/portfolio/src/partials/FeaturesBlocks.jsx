        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Cloud migration</h4>
              <p className="text-gray-600 text-center">Migrating between cloud providers and on-premise.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Cloud hosting</h4>
              <p className="text-gray-600 text-center">Hosting any website you have with almost 0 downtime.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Consulting and support</h4>
              <p className="text-gray-600 text-center">Will provide IT support with all your cloud/DevOps related problems.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Solution architecture</h4>
              <p className="text-gray-600 text-center">Designing agile, maintaianable and scalable application for any workload.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Back-end Develomment</h4>
              <p className="text-gray-600 text-center">Lightweight and reliable backend, with understandable and maintainable code.</p>
            </div>
